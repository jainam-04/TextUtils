...
export default function About(props) {
      let myStyle = {
            color: props.mode === "dark" ? "white" : "#101146",
            backgroundColor: props.mode === "dark" ? "rgb(82 84 175)" : "white",
      }
      return (
            <>
                  <div className="container my-3" style={{color: props.mode === "dark" ? "white" : "#101146"}}>
